...
import { theme, setTheme, applyTheme, ThemeType } from '../../modules/Theme'; // Import the applyTheme function
        ...
        <div class="p-4">
          <label class="block mb-2">
            ...
            <div class="flex space-x-4 mt-1">
              <button
                class={`p-2 rounded-md size-18 flex flex-col justify-center items-center ${theme() === ThemeType.Light ? 'border-2 border-blue-500' : 'border'}`}
              ...
              <button
                class={`p-2 rounded-md size-18 flex flex-col justify-center items-center ${theme() === ThemeType.Dark ? 'border-2 border-blue-500' : 'border'}`}
              ...
              <button
                class={`p-2 rounded-md size-18 flex flex-col justify-center items-center ${theme() === ThemeType.System ? 'border-2 border-blue-500' : 'border'}`}
                onClick={() => handleThemeChange(ThemeType.System)}
              >
                <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
